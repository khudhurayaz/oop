...
public class PasswordGenerator {
    ...
    public static class PasswordGeneratorBuilder {
         ...
         *
         * @return the {@link de.khudhur.projects.passwordGenerator.PasswordGenerator}
         * object.
         */
    ...
    /**
     * This method will generate a password depending on the use* properties you
     * define. It will use the categories with a probability. It is not sure
     * that all the defined categories will be used.
     *
